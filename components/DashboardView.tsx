    ...
    <div className="space-y-6 pb-12">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
            ...
            <span className="text-xs bg-emerald-100 text-emerald-700 px-2 py-1 rounded-full flex items-center gap-1">
              <Database size={12} /> MongoDB (Cloud)
            </span>
          </h2>
      ...
      <div className="mt-10 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <p className="text-sm text-gray-500 mb-6 max-w-2xl">
          Hệ thống đang sử dụng <strong>MongoDB</strong> trên cloud. Dữ liệu được lưu trữ an toàn, đồng bộ trên nhiều thiết bị. Hãy sao lưu định kỳ để phòng ngừa rủi ro.
        </p>
